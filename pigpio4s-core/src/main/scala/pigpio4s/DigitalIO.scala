...
trait DigitalIO {
    ...
    def gpioRead(gpio: Gpio)(implicit pigpio: PigpioLibrary): Try[DigitalValue]
    def gpioWrite(gpio: Gpio, level: DigitalValue)(implicit pigpio: PigpioLibrary): Try[GpioResult]
